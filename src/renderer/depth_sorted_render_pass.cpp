...
namespace Eon
{
	DepthSortedRenderPass::DepthSortedRenderPass(RenderPipeline& pipeline, const std::string& name, Framebuffer& framebuffer) : FrameBufferRenderPass(pipeline, name, framebuffer)
	{
	}
